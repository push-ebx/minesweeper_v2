...
import {
  MODAL_NUMBER_KEYBOARD, PAGE_CRUSH,
  PAGE_GAMES,
  PAGE_MAIN,
  PAGE_MINES, PAGE_MORE_7_LESS, PAGE_TOP, PAGE_WHEEL, PANEL_CRUSH,
  PANEL_GAMES,
  PANEL_MAIN,
  PANEL_MINES, PANEL_MORE_7_LESS, PANEL_TOP, PANEL_WHEEL,
  VIEW_MAIN
} from "./routes.js";
...
const routes = {
  ...
  [PAGE_WHEEL]: new Page(PANEL_WHEEL, VIEW_MAIN),
  [PAGE_CRUSH]: new Page(PANEL_CRUSH, VIEW_MAIN),
